/**
 * \file dnn/src/wasm/conv_bias/conv1x1/algos.cpp
...
#include "src/wasm/conv_bias/conv1x1/conv1x1_dispatcher.h"
#include "src/wasm/conv_bias/conv1x1/conv1x1_strategy.h"
...
WorkspaceBundle ConvBiasImpl::AlgoConv1x1::get_bundle_according_packmode(
    ...
    if (pack_mode == MatrixMulImpl::AlgoBase::PackMode::DEFAULT) {
        MIDOUT_BEGIN(megdnn_wasm_conv1x1,
...
bool ConvBiasImpl::AlgoConv1x1::usable(const NCBKernSizeParam& param,
    ...
    MIDOUT_BEGIN(megdnn_wasm_conv1x1, 0, 2) {
