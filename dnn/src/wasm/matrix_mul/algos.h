/**
 * \file dnn/src/wasm/matrix_mul/algos.h
...
public:
    ...
    MEGDNN_DECL_ALGO_TYPE(WASM_F32K8x12x1)
    MEGDNN_REG_GEMM_FUNC_FOR_IM2COL();
};

class MatrixMulImpl::AlgoGemv final : public AlgoBase {
public:
    const char* name() const override { return "WASM_GEMV"; }
    bool usable(const KernSizeParam&) const override;
    ...
    MEGDNN_DECL_ALGO_TYPE(WASM_GEMV)
