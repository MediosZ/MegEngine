/**
 * \file dnn/src/wasm/conv_bias/im2col/strategy_base.h
...
using PackMode = wasm::MatrixMulImpl::AlgoBase::PackMode;
...
public:
    ...
    virtual void copy_padding_kern(
            ...
            const wasm::ConvBiasImpl::NCBKernParam& param,
            const wasm::ConvBiasImpl::NCBKernIndex& ncb_index,
            size_t pack_size) = 0;
    virtual void packA_kern(
            const WorkspaceBundle& bundle,
            const wasm::ConvBiasImpl::NCBKernParam& param,
            wasm::MatrixMulImpl::KernSizeParam matmulparam,
            const wasm::MatrixMulImpl::AlgoBase* matmul_algo,
            const wasm::ConvBiasImpl::NCBKernIndex& ncb_index,
            const wasm::MatrixMulImpl::AlgoBase::MatmulDescription&
                    matmul_desec,
    ...
    virtual void exec_im2col(
            ...
            const wasm::ConvBiasImpl::NCBKernParam& param,
            wasm::MatrixMulImpl::KernParam matmul_param,
            const wasm::MatrixMulImpl::AlgoBase* matmul_algo) = 0;
...
inline void* get_matmul_dst_ptr(const wasm::ConvBiasImpl::NCBKernParam& param,
                           const WorkspaceBundle& bundle_thread,
                           const StrategyParam& sparam,
...
void copy_dst(const wasm::ConvBiasImpl::NCBKernParam& param,
...
template <typename bias_ctype>
void copy_bias(const wasm::ConvBiasImpl::NCBKernParam& param,
               const WorkspaceBundle& bundle_thread,
...
void do_postprocess(const wasm::ConvBiasImpl::NCBKernParam& param,
                    const StrategyParam& sparam,
                    const WorkspaceBundle& bundle_thread,
...
public:
    ...
    virtual void exec_im2col(
            ...
            const wasm::ConvBiasImpl::NCBKernParam& param,
            wasm::MatrixMulImpl::KernParam matmul_param,
            const wasm::MatrixMulImpl::AlgoBase* matmul_algo) override;

    void exec_matmul(const wasm::ConvBiasImpl::NCBKernParam& param,
                     const StrategyParam& sparam, const WorkspaceBundle& bundle,
                     const WorkspaceBundle& bundle_thread,
                     wasm::MatrixMulImpl::KernParam matmul_param,
                     const wasm::MatrixMulImpl::AlgoBase* matmul_algo,
    ...
    void exec_postprocess(const wasm::ConvBiasImpl::NCBKernParam& param,
                          const StrategyParam& sparam,
    ...
    void* get_matmul_dst_ptr(const wasm::ConvBiasImpl::NCBKernParam& param,
                             const WorkspaceBundle& bundle_thread,
                             const StrategyParam& sparam);
};
...
public:
    ...
    void packA_kern(
            ...
            const wasm::MatrixMulImpl::AlgoBase* matmul_algo,
            const wasm::ConvBiasImpl::NCBKernIndex& ncb_index,
            const wasm::MatrixMulImpl::AlgoBase::MatmulDescription& MDsec,
            const StrategyParam& sparam) override;
