/**
 * \file dnn/src/wasm/conv_bias/im2col/im2col_kerns.h
...
using Pack_Mode=wasm::MatrixMulImpl::AlgoBase::PackMode;
/*!
...
static void kerns(
        ...
        wasm::MatrixMulImpl::KernSizeParam matmul_kernsize_param,
        const wasm::MatrixMulImpl::AlgoBase* matmul_algo,
        const wasm::MatrixMulImpl::AlgoBase::MatmulDescription& matmul_desc,
        StrategyParam strategyparam,
        wasm::ConvBiasImpl::NCBKernIndex ncb_index, size_t ohw_tile_size,
    ...
    static_cast<wasm::MatrixMulImpl::KernSizeParam&>(matmul_param) =
...
public:
    ...
    WorkspaceBundle get_thread_bundle(
            ...
            const wasm::MatrixMulImpl::KernSizeParam& im2col_kern_param,
