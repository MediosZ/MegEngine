/**
 * \file dnn/src/wasm/convolution/algos.h
...
public:
    ...
    MEGDNN_DECL_ALGO_TYPE(WASM_ALGO)
};
...
public:
    ...
    MEGDNN_DECL_ALGO_TYPE(WASM_DEFAULT)
...
public:
    ...
    MEGDNN_DECL_ALGO_TYPE(WASM_DIRECT)
};
...
public:
    ...
    MEGDNN_DECL_ALGO_TYPE(WASM_MATMUL)
};
