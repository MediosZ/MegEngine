/**
 * \file dnn/src/wasm/conv_bias/im2col/factory.h
...
MIDOUT_DECL(megdnn_wasm_im2col_factory_make_strategy)
...
struct StrategyHashParam {
    ...
    wasm::ConvBiasImpl::NCBKernSizeParam param;
    param::ConvBias::Format format;
    wasm::MatrixMulImpl::AlgoBase::PackMode packmode;
};
...
public:
    ...
    Strategy* get(wasm::MatrixMulImpl::AlgoBase* matmul_algo,
...
public:
    static StrategyBase* get_im2col_strategy(
            const wasm::ConvBiasImpl::NCBKernSizeParam& param,
            wasm::MatrixMulImpl::AlgoBase* matmul_algo) {
...
#define cb1(_format, _packmode, _dt, _post_ctype, _postprocess_mode,  \
            _midout_tag)                                              \
    MIDOUT_BEGIN(megdnn_wasm_im2col_factory_make_strategy,        \
            ...
            case StrategyType::FLOAT:
                if (format == param::ConvBias::Format::NCHW) {
                    ...
                    if ((matmul_block.m == 8 || matmul_block.m == 4) &&
                        ...
                        MIDOUT_BEGIN(
                                megdnn_wasm_im2col_factory_make_strategy,
...
Strategy* StrategyDelegationStorage::get(
    ...
    if (packmode == wasm::MatrixMulImpl::AlgoBase::PackMode::DEFAULT ||
        packmode == wasm::MatrixMulImpl::AlgoBase::PackMode::ONLY_PACKA) {
